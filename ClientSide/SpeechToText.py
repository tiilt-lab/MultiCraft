...
class AudioHandler(object):
    def __init__(
            self, rate=16000, channels=2, chunk_size=2048, socket_max_time=600,
            write_interval=10, audio_folder='audio_output'):
        ...
        self.socket_restart_count = int(
            self.RATE / self.CHUNK * socket_max_time)
    ...
    def on_message(self, ws, msg):
        data = json.loads(msg)
        if 'results' in data.keys() and data['results'][0]['final'] is True:
