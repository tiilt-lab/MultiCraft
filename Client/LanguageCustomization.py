...
data = {"name" : "Multicraft (with Materials) v2", "base_model_name" : "en-US_BroadbandModel", "description" : "Custom Speech to Text model for MultiCraft with updated materials dictionary corpus"}
...
corpus_name = "keywords and materials"
